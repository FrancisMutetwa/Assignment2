...
public class Clubgoer extends Thread {
	...
	static AtomicBoolean pauseFlag = new AtomicBoolean(false); //initially set to false
	static AtomicBoolean startFlag = new AtomicBoolean(false); //initially set to false
